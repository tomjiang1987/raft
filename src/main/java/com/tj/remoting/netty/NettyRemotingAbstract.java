...
import com.tj.remoting.ChannelEventListener;
import com.tj.remoting.InvokeCallback;
import com.tj.remoting.RPCHook;
import com.tj.remoting.common.Pair;
...
import com.tj.remoting.common.SemaphoreReleaseOnlyOnce;
import com.tj.remoting.common.ServiceThread;
...
import com.tj.remoting.protocol.RemotingSysResponseCode;
...
public abstract class NettyRemotingAbstract {
    ...
    public void invokeAsyncImpl(final Channel channel, final RemotingCommand request,
            final long timeoutMillis, final InvokeCallback invokeCallback) throws InterruptedException, RemotingTimeoutException, RemotingSendRequestException {
        ...
        if (acquired) {
			...
			String info = String
					.format("invokeAsyncImpl tryAcquire semaphore timeout, %dms, waiting thread nums: %d semaphoreAsyncValue: %d", //
							timeoutMillis,//
